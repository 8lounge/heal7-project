...
from paperwork_services.config.api_config import APIConfig
...
async def get_scraping_status():
    ...
    try:
        # 스케줄러 상태 확인
        from services.government_portal_scraper.scheduler_config import scraping_scheduler
        scheduler_status = scraping_scheduler.get_scheduler_status()
        
        # 중복 필터 상태 확인
        from services.government_portal_scraper.duplicate_filter import duplicate_filter
    ...
    try:
        ...
        test_records = [
            ...
            },
            {
                ...
                "application_period": "2025.02.01 ~ 2025.11.30",
