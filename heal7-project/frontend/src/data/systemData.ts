...
export const notices: Notice[] = [
  {
    id: 'notice-001',
    type: 'system',
    title: '🎉 HEAL7 플랫폼 2.0 업데이트 완료!',
    content: `
# HEAL7 플랫폼 2.0 주요 업데이트 사항 ✨
...
감사합니다! 💜
    `,
    summary: 'HEAL7 플랫폼 2.0 업데이트 완료! AI 사주분석, 타로, 매거진, 1:1 상담 등 새로운 기능 추가',
...
지금 바로 프리미엄의 차이를 경험해보세요! ✨
  ...
  },
  {
    id: 'notice-005',
    type: 'system',
    title: '📱 HEAL7 모바일 앱 출시 예정!',
    content: `
# 📱 HEAL7 모바일 앱 곧 출시!

언제 어디서나 편리하게! HEAL7 모바일 앱이 곧 출시됩니다.
...
많은 기대 부탁드립니다! 📲
    `,
    summary: 'HEAL7 모바일 앱 9월 안드로이드, 10월 iOS 출시 예정. 푸시 알림, 오프라인 기능 등 추가',
