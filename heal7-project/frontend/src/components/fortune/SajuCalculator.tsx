    ...
    queryFn: async () => {
      try {
        const apiEndpoint = viewMode === 'cyber_fantasy' 
          ? '/api/fortune/saju/cyber' 
          : '/api/fortune/saju/basic'
        ...
        >
          ...
          {!showResult ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-400">AI가 당신의 운명을 분석하는 중...</p>
                ...
                >
                  ...
                  <div className="flex flex-wrap justify-center gap-1">
                    {selectedResult.mzSummary.hashTags.map((tag, index) => (
                      <span key={index} className="text-xs bg-purple-500/30 text-purple-200 px-2 py-1 rounded-full">
                        {tag}
                      </span>
                    ))}
                  </div>
                        ...
                        <div className="p-4 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-lg">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            {selectedResult.lifeAspects.career.suitableJobs.map((job, index) => (
                              <motion.div
                                key={index}
                                className="bg-purple-500/30 text-purple-200 px-3 py-2 rounded-lg text-sm text-center"
                    ...
                    {activeTab === 'love' && (
                      <div className="space-y-4">
                        ...
                        <div className="p-4 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-lg">
                          ...
                          <p className="text-purple-200 text-sm mb-3">{selectedResult.lifeAspects.love.idealType}</p>
            ...
            <div className="text-center py-12">
              <div className="text-6xl mb-4">🔮</div>
              <p className="text-gray-400 mb-4">
                잠시만요, AI가 더 정확한 분석을 준비중이에요
              </p>
              <motion.button
                onClick={handleCalculate}
                className="px-6 py-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg text-white font-medium"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                🎯 다시 분석하기
