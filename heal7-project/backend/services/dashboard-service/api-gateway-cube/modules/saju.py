...
async def analyze_saju(request: SajuRequest, saju_service: SajuService = Depends(get_saju_service)):
    ...
    try:
        ...
        result = SajuResult(
            ...
            birth_info={
                "year": saju_result.year,
                "month": saju_result.month,
                "day": saju_result.day,
                "hour": saju_result.hour,
                "minute": saju_result.minute,
                "gender": saju_result.gender.value,
                "is_lunar": saju_result.is_lunar,
                "birth_datetime": saju_result.birth_datetime.isoformat()
            },
            four_pillars={
            ...
            element_balance={k.value: v for k, v in saju_result.items()},
...
async def check_compatibility(person1: SajuRequest, person2: SajuRequest, saju_service: SajuService = Depends(get_saju_service)):
    ...
    try:
        ...
        birth_info_1 = BirthInfo(
            ...
            gender=Gender.MALE if person1.lower() == "male" else Gender.FEMALE,
            name=person1.name,
        ...
        birth_info_2 = BirthInfo(
            ...
            gender=Gender.MALE if person2.lower() == "male" else Gender.FEMALE,
            name=person2.name,
