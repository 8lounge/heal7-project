...
const SajuAdminDashboard: React.FC = () => {
  ...
  const StatsCard: React.FC<{
    ...
    return (
      <Card className={`bg-black/40 backdrop-blur-xl rounded-2xl border border-white/20 hover:border-purple-400/50 shadow-2xl transition-all duration-500 group ${isRefreshing ? 'animate-pulse' : ''}`} style={{background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.3))', backdropFilter: 'blur(20px)'}}>
  ...
  return (
    <div className={`min-h-screen theme-transition ${
      ...
      <div className="container mx-auto p-6">
        ...
        <div className={`backdrop-blur-xl rounded-2xl p-6 mb-6 shadow-2xl border transition-all duration-500 ${
          ...
          <div className="flex justify-between items-center">
            ...
            <Button 
              ...
              className="relative bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-400 hover:to-indigo-500 backdrop-blur-xl border border-purple-400/30 text-white shadow-2xl hover:shadow-purple-500/25 transition-all duration-500 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 hover:-translate-y-0.5 px-6 py-3 rounded-xl font-semibold"
            >
        ...
        {/* 메인 네비게이션 - 개별 버튼 스타일 */}
        <div className="bg-black/40 backdrop-blur-xl rounded-2xl p-6 mb-6 shadow-2xl border border-white/20" style={{background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.3))', backdropFilter: 'blur(20px)'}}>
            ...
            <button
              ...
              className={`
                ...
                ${activeTab === 'dashboard'
                  ...
                  : 'text-white/70 hover:text-white hover:bg-gradient-to-br hover:from-white/15 hover:to-white/5 hover:shadow-2xl hover:shadow-purple-500/10 hover:scale-105 border border-white/20 hover:border-purple-400/40 backdrop-blur-xl'
                }
              `}
            >
        ...
        <div className="space-y-6">
          ...
          {activeTab === 'dashboard' && (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* 시스템 상태 */}
              <Card className={`bg-black/40 backdrop-blur-xl rounded-2xl border border-white/20 hover:border-purple-400/50 shadow-2xl transition-all duration-500 group ${refreshingSection === 'system' ? 'animate-pulse border-purple-400/50' : ''}`} style={{background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.3))', backdropFilter: 'blur(20px)'}}>
                <CardHeader>
              ...
              {/* 인기 기능 */}
              <Card className={`bg-black/40 backdrop-blur-xl rounded-2xl border border-white/20 hover:border-purple-400/50 shadow-2xl transition-all duration-500 group ${refreshingSection === 'analytics' ? 'animate-pulse border-purple-400/50' : ''}`} style={{background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.3))', backdropFilter: 'blur(20px)'}}>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-white/90 group-hover:glow-text-purple transition-all duration-300">
          ...
          {activeTab === 'saju-engine' && (
            ...
            {/* 알고리즘 상태 */}
            <Card className="bg-black/40 backdrop-blur-xl rounded-2xl border border-white/20 hover:border-purple-400/50 shadow-2xl transition-all duration-500 group" style={{background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.3))', backdropFilter: 'blur(20px)'}}>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-white/90 group-hover:glow-text-purple transition-all duration-300">
            ...
            <Card className="bg-black/40 backdrop-blur-xl rounded-2xl border border-white/20 hover:border-purple-400/50 shadow-2xl transition-all duration-500 group" style={{background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.3))', backdropFilter: 'blur(20px)'}}>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <Button 
                    variant="outline" 
                    className="h-20 flex flex-col bg-gradient-to-br from-black/20 to-black/10 backdrop-blur-xl border border-white/20 text-white/80 hover:bg-gradient-to-br hover:from-purple-500/25 hover:to-indigo-500/15 hover:border-purple-400/50 hover:text-white hover:shadow-2xl hover:shadow-purple-500/20 hover:scale-105 hover:-translate-y-1 transition-all duration-500"
                  >
                        ...
                        <div className="flex gap-2 mb-4">
                          <div className="flex-1 relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-4 py-2 bg-gradient-to-r from-black/20 to-black/10 backdrop-blur-xl border border-white/20 rounded-lg text-white/90 placeholder:text-white/40 focus:outline-none focus:border-purple-400/70 focus:ring-2 focus:ring-purple-400/20 focus:shadow-lg focus:shadow-purple-500/10 transition-all duration-300"
                            />
                          </div>
                          <Button 
                            size="sm" 
                            variant="outline"
                            className="px-4 bg-gradient-to-r from-black/20 to-black/10 backdrop-blur-xl border border-white/20 text-white/80 hover:bg-gradient-to-r hover:from-purple-500/20 hover:to-indigo-500/10 hover:border-purple-400/50 hover:text-white hover:shadow-lg hover:shadow-purple-500/15 hover:scale-105 transition-all duration-300"
                          >
        ...
        {/* 하단 상태 바 - 사이버 판타지 스타일 */}
        <div className="bg-black/40 backdrop-blur-xl rounded-2xl p-4 mt-6 shadow-2xl border border-white/20 hover:border-purple-400/50 transition-all duration-500" style={{background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.3))', backdropFilter: 'blur(20px)'}}>
