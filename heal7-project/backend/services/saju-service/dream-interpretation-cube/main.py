#!/usr/bin/env python3
"""
HEAL7 DREAM-INTERPRETATION-SYSTEM 큐브
꿈 해몽 및 분석 시스템
...
# FastAPI 앱 생성
app = FastAPI(
    title=f"HEAL7 Dream-Interpretation-System",
    description=cube_config["cube"]["purpose"],
    version=cube_config["cube"]["version"],
    docs_url=f"/api/dream-interpretation/docs"
)
...
@app.get("/api/dream-interpretation/status")
