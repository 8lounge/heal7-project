        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className={`bg-white/10 backdrop-blur-sm rounded-lg p-4 border ${
                stat.urgent ? 'border-red-400/50' : 'border-white/20'
              }`}>
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300 text-sm">{inquiry.content}</p>
                      </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">고급 분석 모드</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">자동 해석 업데이트</span>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" defaultChecked className="sr-only peer" />
                    <div className="w-11 h-6 bg-gray-600 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600"></div>
                  </label>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">캐시 자동 갱신</span>
                  <div className="flex items-center gap-2">
                    <input type="number" defaultValue="24" className="w-16 px-2 py-1 bg-white/10 border border-white/20 rounded text-white text-center" />
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">새 문의 알림</span>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" defaultChecked className="sr-only peer" />
                    <div className="w-11 h-6 bg-gray-600 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600"></div>
                  </label>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">시스템 오류 알림</span>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" defaultChecked className="sr-only peer" />
                    <div className="w-11 h-6 bg-gray-600 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600"></div>
                  </label>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">매출 리포트</span>
                  <select className="px-3 py-1 bg-white/10 border border-white/20 rounded text-white text-sm">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">최대 동시 접속자</span>
                  <div className="flex items-center gap-2">
                    <input type="number" defaultValue="1000" className="w-20 px-2 py-1 bg-white/10 border border-white/20 rounded text-white text-center" />
                    <span className="text-gray-400">명</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">세션 유지 시간</span>
                  <div className="flex items-center gap-2">
                    <input type="number" defaultValue="30" className="w-16 px-2 py-1 bg-white/10 border border-white/20 rounded text-white text-center" />
                    <span className="text-gray-400">분</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">API 요청 제한</span>
                  <div className="flex items-center gap-2">
                    <input type="number" defaultValue="100" className="w-16 px-2 py-1 bg-white/10 border border-white/20 rounded text-white text-center" />
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">백업 보관 기간</span>
                  <div className="flex items-center gap-2">
                    <input type="number" defaultValue="30" className="w-16 px-2 py-1 bg-white/10 border border-white/20 rounded text-white text-center" />
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-300">사용자 로그인: 김○○</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-3 h-3 text-gray-400" />
                  <span className="text-gray-400">15:28</span>
                  <span className="text-blue-400">INFO</span>
                  <span className="text-gray-300">사주 분석 완료: ID#12345</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-3 h-3 text-gray-400" />
                  <span className="text-gray-400">15:25</span>
                  <span className="text-yellow-400">WARN</span>
                  <span className="text-gray-300">메모리 사용률 증가: 67%</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2 p-3 bg-yellow-500/10 border border-yellow-400/20 rounded">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-xs">현재 67% 사용 중, 모니터링 필요</p>
                  </div>
                </div>
                <div className="flex items-start gap-2 p-3 bg-blue-500/10 border border-blue-400/20 rounded">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-xs">일일 백업이 성공적으로 완료됨</p>
                  </div>
                </div>
              </div>
            </div>
